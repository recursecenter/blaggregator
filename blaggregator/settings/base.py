...
LOGIN_URL = "/login/"
HS_PERSONAL_TOKEN = os.environ["HS_PERSONAL_TOKEN"]
SOCIAL_AUTH_HACKERSCHOOL_KEY = os.environ["SOCIAL_AUTH_HS_KEY"]
SOCIAL_AUTH_HACKERSCHOOL_SECRET = os.environ["SOCIAL_AUTH_HS_SECRET"]
