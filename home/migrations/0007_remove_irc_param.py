...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hacker.irc'
        db.delete_column(u'home_hacker', 'irc')


    def backwards(self, orm):
        # Adding field 'Hacker.irc'
        db.add_column(u'home_hacker', 'irc',
    ...
    models = {
        ...
        u'home.comment': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "'Yf5QM7'", 'unique': 'True', 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'home.hacker': {
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'1z4Fb4'", 'unique': 'True', 'max_length': '6'}),
