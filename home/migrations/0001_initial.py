...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Hacker'
        db.create_table(u'home_hacker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('avatar_url', self.gf('django.db.models.fields.CharField')(max_length=400, blank=True)),
            ...
            ('irc', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'home', ['Hacker'])

        # Adding model 'Blog'
        db.create_table(u'home_blog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('feed_url', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('last_crawled', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'home', ['Blog'])

        # Adding model 'Post'
        db.create_table(u'home_post', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Blog'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'home_hacker')

        # Deleting model 'Blog'
        db.delete_table(u'home_blog')
