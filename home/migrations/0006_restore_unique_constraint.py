...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Comment', fields ['slug']
        db.create_unique(u'home_comment', ['slug'])

        # Adding unique constraint on 'Post', fields ['slug']
        db.create_unique(u'home_post', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Post', fields ['slug']
        db.delete_unique(u'home_post', ['slug'])

        # Removing unique constraint on 'Comment', fields ['slug']
        db.delete_unique(u'home_comment', ['slug'])
    ...
    models = {
        ...
        u'home.comment': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "'6agAM4'", 'unique': 'True', 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'home.hacker': {
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'T9wVgj'", 'unique': 'True', 'max_length': '6'}),
