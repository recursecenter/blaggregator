...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'home_comment', (
            ...
            ('slug', self.gf('django.db.models.fields.CharField')(default='BsQx02', max_length=6, unique=True)),
        ))
    ...
    models = {
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'OvAVuW'", 'unique': 'True', 'max_length': '6'}),
