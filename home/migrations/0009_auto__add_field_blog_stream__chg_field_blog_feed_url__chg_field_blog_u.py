...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.stream'
        db.add_column(u'home_blog', 'stream',
                      self.gf('django.db.models.fields.CharField')(default='BLOGGING', max_length=100),
                      keep_default=False)


        # Changing field 'Blog.feed_url'
        db.alter_column(u'home_blog', 'feed_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Blog.url'
        db.alter_column(u'home_blog', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Blog.stream'
        db.delete_column(u'home_blog', 'stream')
    ...
    models = {
        ...
        u'home.comment': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "'zEqcaa'", 'unique': 'True', 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'home.hacker': {
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'mVIaBA'", 'unique': 'True', 'max_length': '6'}),
