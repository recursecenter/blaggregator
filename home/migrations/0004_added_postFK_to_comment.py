...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'home_comment', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['home.Post']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.post'
        db.delete_column(u'home_comment', 'post_id')
    ...
    models = {
        ...
        u'home.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_id': ('django.db.models.fields.CharField', [], {'default': "'a6uSyk'", 'unique': 'True', 'max_length': '6'}),
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_id': ('django.db.models.fields.CharField', [], {'default': "'C9F69U'", 'unique': 'True', 'max_length': '6'}),
