...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'home_logentry', (
        ...
        db.send_create_signal(u'home', ['LogEntry'])


    def backwards(self, orm):
        # Deleting model 'LogEntry'
        db.delete_table(u'home_logentry')
    ...
    models = {
        ...
        u'home.comment': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "'A2ldrr'", 'unique': 'True', 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'home.hacker': {
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'S4VzlM'", 'unique': 'True', 'max_length': '6'}),
