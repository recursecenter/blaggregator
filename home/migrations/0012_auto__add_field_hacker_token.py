...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hacker.token'
        db.add_column(u'home_hacker', 'token',
                      self.gf('django.db.models.fields.SlugField')(default='this is a one-off default', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hacker.token'
        db.delete_column(u'home_hacker', 'token')
    ...
    models = {
        ...
        u'home.comment': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "'Mg85V2'", 'unique': 'True', 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'home.hacker': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.SlugField', [], {'default': "'this is a one-off default'", 'max_length': '40'}),
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'qT3QGq'", 'unique': 'True', 'max_length': '6'}),
