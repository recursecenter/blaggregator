...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'home_post', 'date_updated', 'date_posted_or_crawled')

    def backwards(self, orm):
        # Renaming field 'Post.date_posted_or_crawled'
        db.rename_column(u'home_post', 'date_posted_or_crawled', 'date_updated')
    ...
    models = {
        ...
        u'home.comment': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "'BsQx02'", 'unique': 'True', 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'home.hacker': {
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'xO9X6i'", 'unique': 'True', 'max_length': '6'}),
